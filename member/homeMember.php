	...
	<div class="container pb-xl-5 pb-lg-3">
		...
		<div class="col-lg-12 main_grid_contact" data-aos="flip-left" data-aos-easing="ease-out-cubic"
			...
			<div class="form-w3ls p-md-10 p-4">
				<center>
					<h4 class="mb-4 sec-title-w3 let-spa text-bl">Data Diri<br><h5>Lengkapi Data Diri Anda Dengan Benar</h5></h4>
				</center>
				...
				<form action="proses.php" method="POST" enctype="multipart/form-data" >
					...
					<label for="">Pekerjaan Orang Tua</label>
						<input class="form-control" type="text" name="kerja" placeholder=""  >
					</div>
				...
				<div style="color:red" class="fa fa-bullhorn"><b>Info Penting</b></div>
